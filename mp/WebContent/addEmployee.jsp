...
<body>
	...
	<form action = "AddEmployeeServlet" method = "POST" enctype="multipart/form-data" onsubmit="return checkForm(this);">
		...
		<div class="form-group">
			...
			<div>
				<label for="usrname">Company:</label>
						<input type="text" class="form-control" id="usrname" placeholder="De La Salle University" name = "company" required>
					</div>
			<div>
				<label for="password">Position:</label>
						<input type="text" class="form-control" id="password" placeholder="Developer" name = "position" required>
			</div>
			<div class="col-sm-3">
