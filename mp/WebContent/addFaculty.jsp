...
<body>
	...
	<form action = "AddFacultyServlet" method = "POST" enctype="multipart/form-data" onsubmit="return checkForm(this);">
		...
		<div class="form-group">
			...
			<div>
				<label for="password">Department:</label>
						<input type="text" class="form-control" id="password" placeholder="Philosophy" name = "department" required>
			</div>
			<div class="col-sm-3">
